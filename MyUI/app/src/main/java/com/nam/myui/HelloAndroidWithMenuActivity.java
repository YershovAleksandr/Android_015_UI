...
public class HelloAndroidWithMenuActivity extends AppCompatActivity {
	public void onCreate(Bundle savedInstanceState) {
		...
		TextView tv = (TextView) findViewById(R.id.m2mnutext_view);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.even_more_help:
			return true;
		case R.id.give_up:
			Toast.makeText(getApplicationContext(), "Motherfucka!!!", Toast.LENGTH_SHORT).show();
			return true;
		default:
			return false;
		}
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.help_guide:
			...
			return true;
		case R.id.help_fuck:
			Toast.makeText(getApplicationContext(), "Motherfucka", Toast.LENGTH_LONG).show();
