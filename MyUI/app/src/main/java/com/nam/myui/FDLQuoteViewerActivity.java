...
import com.nam.myui.FDLTitlesFragment.ListSelectionListener;

//Several Activity lifecycle methods are instrumented to emit LogCat output
//so you can follow this class' lifecycle
public class FDLQuoteViewerActivity extends Activity implements ListSelectionListener {

	public static String[] mTitleArray;
	public static String[] mQuoteArray;


	private final FDLQuotesFragment mQuoteFragment = new FDLQuotesFragment();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragmentdynamiclayout);
		...
		fragmentTransaction.add(R.id.title_fragment_container, new FDLTitlesFragment());
