...
public class FDLAQuoteFragment extends Fragment {

	private TextView mQuoteView = null;
	private int mCurrIdx = FDLAQuoteViewerActivity.UNSELECTED;
	...
	public void showQuoteAtIndex(int newIndex) {
		if (newIndex < 0 || newIndex >= mQuoteArrLen)
			return;
		mCurrIdx = newIndex;
		mQuoteView.setText(FDLAQuoteViewerActivity.QuoteArray[mCurrIdx]);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fdladetail_fragment, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mQuoteArrLen = FDLAQuoteViewerActivity.QuoteArray.length;
	}

	@Override
	public void onDetach() {
		super.onDetach();
		mCurrIdx = FDLAQuoteViewerActivity.UNSELECTED;
	}
