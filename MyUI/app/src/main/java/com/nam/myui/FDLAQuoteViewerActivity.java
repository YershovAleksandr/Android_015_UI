...
import com.nam.myui.FDLATitlesFragment.ListSelectionListener;

public class FDLAQuoteViewerActivity extends AppCompatActivity implements ListSelectionListener {

	public static String[] TitleArray;
	public static String[] QuoteArray;
	private final FDLATitlesFragment mTitlesFragment = new FDLATitlesFragment();
	private final FDLAQuoteFragment mDetailsFragment = new FDLAQuoteFragment();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragmentdynamiclayoutwithactionbar);
		...
		fragmentTransaction.add(R.id.atitle_fragment_container, mTitlesFragment);
	...
	public void onListSelection(int index) {
		...
		if (!mDetailsFragment.isAdded()) {
			...
			fragmentTransaction.add(R.id.aquote_fragment_container, mDetailsFragment);
