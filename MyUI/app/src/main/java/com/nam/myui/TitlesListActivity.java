...
public class TitlesListActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<String>(TitlesListActivity.this, R.layout.fqvalist_text_item_layout, TitlesListActivity.mTitleArray));
	...
	public void onListItemClick(ListView l, View v, int pos, long id) {
		...
		Intent showItemIntent = new Intent(TitlesListActivity.this, QuoteListActivity.class);
