...
public class FDLATitlesFragment extends ListFragment {
	...
	public void onActivityCreated(Bundle savedState) {
		...
		setListAdapter(new ArrayAdapter<String>(getActivity(), R.layout.fdlalist_item, FDLAQuoteViewerActivity.TitleArray));

		// If a title has already been selected in the past, reset the selection state now
		if (mCurrIdx != FDLAQuoteViewerActivity.UNSELECTED) {
